                ...
                <div class="letgo-plg-console">
                    <div class="letgo-plg-console__header">
                        <div class="letgo-plg-console__header-left">
                            ...
                            <Tag count={0}>
                                <CloseOne size={14} style="color: #f5222d;"></CloseOne>
                            </Tag>
                            <Tag count={0}>
                                <Caution size={14} style="color: #faad14;"></Caution>
                            </Tag>
                            <Tag count={0}>
                                <Log size={14}></Log>
                            </Tag>
                        </div>
                        <span class="letgo-plg-console__header-clear">
                    ...
                    <div class="letgo-plg-console__container">
                        内容
                    </div>
                </div>
            );
