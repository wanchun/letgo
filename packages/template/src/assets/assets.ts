...
const assets: IPublicTypeAssetsJson = {
    packages: [
        ...
        },
        {
            ...
            version: '0.8.34',
            urls: [
                'https://registry.npmmirror.com/@fesjs/fes-design/0.8.34/files/dist/fes-design.js',
                'https://registry.npmmirror.com/@fesjs/fes-design/0.8.34/files/dist/fes-design.css',
            ],
            library: 'FesDesign',
        },
    ],
